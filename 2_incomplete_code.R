...
univariate_results <- univariate_results %>% 
  t_test(dependent_variable ~ independent_variable, p.adjust.method = )
...
# Now, copy and paste the previous loop and make any necessary changes so it runs correctly
